...
<body>
  ...
  <!--Home Section with title of page-->
  <div id="wallpaper">
  <section id="home">
    <div id="page-header">
    ...
    <div class="container">
      ...
      <p class="imagetext">Crisis Core</p><img src="CrisisCore.webp" alt="Crisis Core">      
      <p class="imagetext">Original FF7</p><img src="Original_FF7.jpg" alt="Original FF7">
      <p class="imagetext">FF7 Remake/Rebirth</p><img src="FF7_Remake.webp" alt="FF7 Remake/Rebirth">
      <p class="imagetext">Advent Children</p><img src="AdventChildren.webp" alt="Advent Children">
      <p class="imagetext">Dirge of Cerberus(cameo)</p><img src="DoC.webp" alt="Dirge of Cerberus">
    </div>
  </section>
  <!--Character Timeline copied from the wiki page of Cloud https://finalfantasy.fandom.com/wiki/Cloud_Strife#History-->
  ...
  <section id="Swords">
    <h1>Cloud's Swords</h1>
      <div id="sword-images">
        ...
        <div class="card">
          <div class="card-image">
            <img src="https://static.wikia.nocookie.net/finalfantasy/images/a/af/Enhance_Sword_FF7.png" alt="butterfly edge">
          </div>
          <div class="card-content">
            <h3>Enhance Sword</h3>
          </div>
